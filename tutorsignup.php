...
<div class="form-group">
<input type="text" id="education" class="form-control education" placeholder="Education">
<div class="invalid-feedback" style="font-size:16px;"> Education information is required</div>
</div>
<div class="form-group">
